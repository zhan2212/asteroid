...
public class GamePanel extends Panel {
	...
	private void drawScore(Graphics g) {
		...
		if (CommandCenter.getInstance().getScore() != 0) {
			g.drawString("SCORE: " + CommandCenter.getInstance().getScore()
					+"  LEVEL:" + CommandCenter.getInstance().getLevel()
					+"  FALCON: " + CommandCenter.getInstance().getNumFalcons()
					, nFontWidth, nFontHeight);
		} else {
			g.drawString("NO SCORE" +"  LEVEL: " + CommandCenter.getInstance().getLevel()
							+"  FALCON: " + CommandCenter.getInstance().getNumFalcons()
					, nFontWidth, nFontHeight); // indicate level
		}
	}
